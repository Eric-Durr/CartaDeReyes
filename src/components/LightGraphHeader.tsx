...
const LightGraphIsland: React.FC = () => {
    ...
    // Nuevo: indica si hay cámara/vídeo activo
    const [hasActiveSource, setHasActiveSource] = useState(false);
    ...
    const handleStart = async () => {
        ...
        try {
            ...
            // Si ha llegado aquí sin lanzar error, hay fuente activa
            setHasActiveSource(true);
        } catch (err) {
            console.error(err);
    ...
    const toggleFullscreen = () => {
        ...
        if (supportsNative) {
            if (!isNativeFs) {
                ...
                setPanelOpen(false); // panel oculto por defecto al entrar
            } else {
    ...
    return (
        <section className="blob-tracker">
            ...
            {/* Layout principal: preview + panel lateral */}
            <div className="lg-layout-main">
                {/* Columna izquierda: estado + canvas/video */}
                <div>
                    ...
                    <div id="videoWrapper" className="video-wrapper">
                        ...
                        {/* Botón circular de grabar estilo cámara (solo si hay fuente activa) */}
                        {hasActiveSource && (
                            <button
                                type="button"
                        ...
                        {/* Botón flotante con flecha para abrir/cerrar menú en fullscreen */}
                        <button
                            type="button"
                            className={
                ...
                {/* Columna derecha: panel de controles de escritorio */}
                <div>
                    <button
                    ...
                    >
                        ...
                        <div className="controls-row">
                            ...
                            {/* Botón de grabación de escritorio solo si hay fuente activa */}
                            {hasActiveSource && (
                                <button
                                    className="secondary-button"
                                    onClick={isRecording ? stopRecording : startRecording}
            ...
            <section className="help">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        fullscreen para capturar lo que se ve en el canvas (solo aparecerán
                        si hay fuente activa).
                    </li>
                </ul>
            </section>
        </section>
